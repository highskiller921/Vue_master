...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/TolrenFrank/vue-element-admin')).toBe(true)
    expect(validURL('http://github.com/TolrenFrank/vue-element-admin')).toBe(true)
    expect(validURL('github.com/TolrenFrank/vue-element-admin')).toBe(false)
  })
  it('validLowerCase', () => {
